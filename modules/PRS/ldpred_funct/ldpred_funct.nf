...
process ldpred_funct {
    ...
    input:
    path plinkfile //"my_plink_files/Final.chrom[1:22]"
    path outCoord //"my_analysis/Coord_Final"
    path statsfile //"my_analysis/sumary_statistics.txt"
    path functfile //"my_analysis/functfile_sldsc.txt"
    path outLdpredfunct //"my_analysis/ldpredfunct_posterior_means"
    path outValidate //"my_analysis/ldpredfunct_prs"
    path phenotype //"my_analysis/trait_1.txt"
